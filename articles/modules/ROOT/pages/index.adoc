...
Data Integration is the process of aggregating data from different sources into a homogenous view, includes data access, transformation, mapping, quality assurance and fusion of data from multiple sources. It is, in effect, offering the fragmented data up as if it were a single database for query.
